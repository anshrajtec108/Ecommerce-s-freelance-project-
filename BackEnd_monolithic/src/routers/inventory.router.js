...
router.post('/add', authMiddleware, validateRequest, addInventory);

// Get inventory details for a product
router.get('/:product_id', authMiddleware, getInventoryByProduct);

// Update inventory quantity for a product
router.put('/update', authMiddleware, validateRequest, updateInventory);

// Delete inventory record for a product
router.delete('/delete/:product_id', authMiddleware, deleteInventory);
